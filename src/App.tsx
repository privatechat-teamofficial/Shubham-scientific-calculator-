...
export default function App() {
  ...
  return (
    <div 
      className={`min-h-screen w-full bg-[#000000] text-slate-100 flex flex-col justify-between max-w-md mx-auto select-none shadow-2xl relative overflow-x-hidden overflow-y-auto font-oryno-bold transition-opacity duration-300 ease-out ${isReady ? 'opacity-100' : 'opacity-0'}`}
